// Constructed regression: issue-slot occupancy. The same 16-load kernel on the
// stock 7-memory-tile array is issue-bound: IssueMII = ceil(130/16) = 9, which
// dominates MemMII=3. Demonstrates the IssueMII bound and large II from op
// count.
...
// CHECK-NEXT:   func.func @mem_kernel(%arg0: !llvm.ptr {llvm.nocapture, llvm.noundef, llvm.readonly}, %arg1: i32 {llvm.noundef}) -> i64 attributes {CConv = #llvm.cconv<ccc>, accelerator = "neura", analytical_cost_model = {analytical_ii = 9 : i32, dominant = "issue", issue_mii = 9 : i32, max_ii = 20 : i32, mem_mii = 3 : i32, rec_mii = 5 : i32, reg_mii = 1 : i32, res_mii = 4 : i32, route_mii = 5 : i32}, dataflow_mode = "predicate", linkage = #llvm.linkage<external>, memory_effects = #llvm.memory_effects<other = none, argMem = read, inaccessibleMem = none>, no_unwind, passthrough = ["nofree", "norecurse", "nosync", ["uwtable", "2"], ["min-legal-vector-width", "0"], ["no-trapping-math", "true"], ["stack-protector-buffer-size", "8"], ["target-cpu", "x86-64"]], target_cpu = "x86-64", target_features = #llvm.target_features<["+cmov", "+cx8", "+fxsr", "+mmx", "+sse", "+sse2", "+x87"]>, tune_cpu = "generic", unnamed_addr = 1 : i64, visibility_ = 0 : i64} {
