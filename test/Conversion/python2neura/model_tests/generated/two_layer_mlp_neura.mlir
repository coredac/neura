...
// DATAFLOW_IR-NEXT: neura.yield {yield_type = "void"}
// DATAFLOW_IR-NEXT: }
// DATAFLOW_IR-NEXT: neura.kernel inputs(%alloc_0, %cst : memref<2x16xf32>, f32) attributes {accelerator = "neura", dataflow_mode = "predicate"} {
// DATAFLOW_IR-NEXT: ^bb0(%arg1: memref<2x16xf32>, %arg2: f32):
...
// INTERPRETER_OUTPUT-NEXT: [-3.764058e-03 1.171000e-02 -2.003852e-02 -1.283500e-02
// INTERPRETER_OUTPUT-NEXT: -3.764018e-03 1.170987e-02 -2.003830e-02 -1.283487e-02]
