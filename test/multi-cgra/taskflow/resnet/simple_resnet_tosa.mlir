...
// KERNEL-NEXT:     %dependency_write_out_4 = taskflow.task @Task_1 dependency_write_in(%alloc_3 : memref<1x10x10x64xf32>) value_inputs(%cst_2 : f32) [original_write_memrefs(%alloc_3 : memref<1x10x10x64xf32>)] {task_type = "static"} : (memref<1x10x10x64xf32>, f32) -> (memref<1x10x10x64xf32>) {
...
// KERNEL-NEXT:       %c1 = arith.constant 1 : index
// KERNEL-NEXT:       %0 = taskflow.counter from %c0 to %c1 step %c1 attributes {counter_dynamism = "static", counter_hierarchy = "root", counter_id = 0 : i32} : index
// KERNEL-NEXT:       %1 = taskflow.counter parent(%0 : index) from %c0 to %c10 step %c1 attributes {counter_dynamism = "static", counter_hierarchy = "relay", counter_id = 1 : i32} : index
// KERNEL-NEXT:       %2 = taskflow.counter parent(%1 : index) from %c0 to %c10 step %c1 attributes {counter_dynamism = "static", counter_hierarchy = "relay", counter_id = 2 : i32} : index
// KERNEL-NEXT:       %3 = taskflow.counter parent(%2 : index) from %c0 to %c64 step %c1 attributes {counter_dynamism = "static", counter_hierarchy = "leaf", counter_id = 3 : i32} : index
...
// KERNEL-NEXT:         %c1_36 = arith.constant 1 : index
// KERNEL-NEXT:         %4 = neura.counter from %c0_35 : index to %c1_36 : index step %c1_36 : index attributes {counter_dynamism = "static", counter_hierarchy = "root", counter_id = 0 : i32} -> index
// KERNEL-NEXT:         %5 = neura.counter from %c0_35 : index to %c10_34 : index step %c1_36 : index attributes {counter_dynamism = "static", counter_hierarchy = "relay", counter_id = 1 : i32} -> index
// KERNEL-NEXT:         %6 = neura.counter from %c0_35 : index to %c10_34 : index step %c1_36 : index attributes {counter_dynamism = "static", counter_hierarchy = "relay", counter_id = 2 : i32} -> index
// KERNEL-NEXT:         %7 = neura.counter from %c0_35 : index to %c64_33 : index step %c1_36 : index attributes {counter_dynamism = "static", counter_hierarchy = "leaf", counter_id = 3 : i32} -> index
...
// KERNEL-NEXT:     %dependency_write_out_6 = taskflow.task @Task_2 dependency_write_in(%alloc_5 : memref<1x8x8x64xf32>) value_inputs(%cst_2 : f32) [original_write_memrefs(%alloc_5 : memref<1x8x8x64xf32>)] {task_type = "static"} : (memref<1x8x8x64xf32>, f32) -> (memref<1x8x8x64xf32>) {
...
// KERNEL-NEXT:       %1 = taskflow.counter parent(%0 : index) from %c0 to %c8 step %c1 attributes {counter_dynamism = "static", counter_hierarchy = "relay", counter_id = 1 : i32} : index
// KERNEL-NEXT:       %2 = taskflow.counter parent(%1 : index) from %c0 to %c8 step %c1 attributes {counter_dynamism = "static", counter_hierarchy = "relay", counter_id = 2 : i32} : index
// KERNEL-NEXT:       %3 = taskflow.counter parent(%2 : index) from %c0 to %c64 step %c1 attributes {counter_dynamism = "static", counter_hierarchy = "relay", counter_id = 3 : i32} : index
// KERNEL-NEXT:       %4 = taskflow.counter parent(%3 : index) from %c0 to %c3 step %c1 attributes {counter_dynamism = "static", counter_hierarchy = "relay", counter_id = 4 : i32} : index
// KERNEL-NEXT:       %5 = taskflow.counter parent(%4 : index) from %c0 to %c3 step %c1 attributes {counter_dynamism = "static", counter_hierarchy = "relay", counter_id = 5 : i32} : index
// KERNEL-NEXT:       %6 = taskflow.counter parent(%5 : index) from %c0 to %c64 step %c1 attributes {counter_dynamism = "static", counter_hierarchy = "leaf", counter_id = 6 : i32} : index
...
// KERNEL-NEXT:         %7 = neura.counter from %c0_36 : index to %c1_37 : index step %c1_37 : index attributes {counter_dynamism = "static", counter_hierarchy = "root", counter_id = 0 : i32} -> index
// KERNEL-NEXT:         %8 = neura.counter from %c0_36 : index to %c8_35 : index step %c1_37 : index attributes {counter_dynamism = "static", counter_hierarchy = "relay", counter_id = 1 : i32} -> index
// KERNEL-NEXT:         %9 = neura.counter from %c0_36 : index to %c8_35 : index step %c1_37 : index attributes {counter_dynamism = "static", counter_hierarchy = "relay", counter_id = 2 : i32} -> index
// KERNEL-NEXT:         %10 = neura.counter from %c0_36 : index to %c64_34 : index step %c1_37 : index attributes {counter_dynamism = "static", counter_hierarchy = "relay", counter_id = 3 : i32} -> index
// KERNEL-NEXT:         %11 = neura.counter from %c0_36 : index to %c3_33 : index step %c1_37 : index attributes {counter_dynamism = "static", counter_hierarchy = "relay", counter_id = 4 : i32} -> index
// KERNEL-NEXT:         %12 = neura.counter from %c0_36 : index to %c3_33 : index step %c1_37 : index attributes {counter_dynamism = "static", counter_hierarchy = "relay", counter_id = 5 : i32} -> index
// KERNEL-NEXT:         %13 = neura.counter from %c0_36 : index to %c64_34 : index step %c1_37 : index attributes {counter_dynamism = "static", counter_hierarchy = "leaf", counter_id = 6 : i32} -> index
...
// KERNEL-NEXT:       %c1 = arith.constant 1 : index
// KERNEL-NEXT:       %0 = taskflow.counter from %c0 to %c1 step %c1 attributes {counter_dynamism = "static", counter_hierarchy = "root", counter_id = 0 : i32} : index
// KERNEL-NEXT:       %1 = taskflow.counter parent(%0 : index) from %c0 to %c64 step %c1 attributes {counter_dynamism = "static", counter_hierarchy = "relay", counter_id = 1 : i32} : index
// KERNEL-NEXT:       %2 = taskflow.counter parent(%1 : index) from %c0 to %c8 step %c1 attributes {counter_dynamism = "static", counter_hierarchy = "relay", counter_id = 2 : i32} : index
// KERNEL-NEXT:       %3 = taskflow.counter parent(%2 : index) from %c0 to %c8 step %c1 attributes {counter_dynamism = "static", counter_hierarchy = "leaf", counter_id = 3 : i32} : index
...
// KERNEL-NEXT:         %c1_36 = arith.constant 1 : index
// KERNEL-NEXT:         %4 = neura.counter from %c0_35 : index to %c1_36 : index step %c1_36 : index attributes {counter_dynamism = "static", counter_hierarchy = "root", counter_id = 0 : i32} -> index
// KERNEL-NEXT:         %5 = neura.counter from %c0_35 : index to %c64_34 : index step %c1_36 : index attributes {counter_dynamism = "static", counter_hierarchy = "relay", counter_id = 1 : i32} -> index
// KERNEL-NEXT:         %6 = neura.counter from %c0_35 : index to %c8_33 : index step %c1_36 : index attributes {counter_dynamism = "static", counter_hierarchy = "relay", counter_id = 2 : i32} -> index
// KERNEL-NEXT:         %7 = neura.counter from %c0_35 : index to %c8_33 : index step %c1_36 : index attributes {counter_dynamism = "static", counter_hierarchy = "leaf", counter_id = 3 : i32} -> index
...
// KERNEL-NEXT:     %dependency_write_out_19 = taskflow.task @Task_7 dependency_write_in(%alloc_18 : memref<1x10x10x64xf32>) value_inputs(%cst_2 : f32) [original_write_memrefs(%alloc_18 : memref<1x10x10x64xf32>)] {task_type = "static"} : (memref<1x10x10x64xf32>, f32) -> (memref<1x10x10x64xf32>) {
// KERNEL-NEXT:     ^bb0(%arg1: memref<1x10x10x64xf32>, %arg2: f32):
// KERNEL-NEXT:       %c64 = arith.constant 64 : index
// KERNEL-NEXT:       %c10 = arith.constant 10 : index
// KERNEL-NEXT:       %c0 = arith.constant 0 : index
...
// KERNEL-NEXT:     %dependency_write_out_21 = taskflow.task @Task_8 dependency_write_in(%alloc_20 : memref<1x8x8x64xf32>) value_inputs(%cst_2 : f32) [original_write_memrefs(%alloc_20 : memref<1x8x8x64xf32>)] {task_type = "static"} : (memref<1x8x8x64xf32>, f32) -> (memref<1x8x8x64xf32>) {
// KERNEL-NEXT:     ^bb0(%arg1: memref<1x8x8x64xf32>, %arg2: f32):
// KERNEL-NEXT:       %c64 = arith.constant 64 : index
// KERNEL-NEXT:       %c8 = arith.constant 8 : index
// KERNEL-NEXT:       %c0 = arith.constant 0 : index
