...
// MAP-SPATIAL-TEMPORAL-4x4-NEXT:       %c1_9 = arith.constant 1 : index
// MAP-SPATIAL-TEMPORAL-4x4-NEXT:       %2 = taskflow.counter parent(%1 : index) from %c0_8 to %c8 step %c1_9 : index
// MAP-SPATIAL-TEMPORAL-4x4-NEXT:       %c0_10 = arith.constant 0 : index
// MAP-SPATIAL-TEMPORAL-4x4-NEXT:       %c6 = arith.constant 6 : index
// MAP-SPATIAL-TEMPORAL-4x4-NEXT:       %c1_11 = arith.constant 1 : index
// MAP-SPATIAL-TEMPORAL-4x4-NEXT:       %3 = taskflow.counter parent(%2 : index) from %c0_10 to %c6 step %c1_11 : index
...
// MAP-SPATIAL-TEMPORAL-4x4-NEXT:       %c1_11 = arith.constant 1 : index
// MAP-SPATIAL-TEMPORAL-4x4-NEXT:       %3 = taskflow.counter parent(%2 : index) from %c0_10 to %c5 step %c1_11 : index
// MAP-SPATIAL-TEMPORAL-4x4-NEXT:       "taskflow.hyperblock"(%1, %2, %3) <{operandSegmentSizes = array<i32: 3, 0>}> ({
...
// MAP-SPATIAL-TEMPORAL-4x4-NEXT:         %6 = arith.addi %4, %5 : i32
// MAP-SPATIAL-TEMPORAL-4x4-NEXT:         %c0_12 = arith.constant 0 : index
// MAP-SPATIAL-TEMPORAL-4x4-NEXT:         %7 = memref.load %arg13[%c0_12] : memref<?xi32>
// MAP-SPATIAL-TEMPORAL-4x4-NEXT:         %8 = arith.addi %7, %6 : i32
// MAP-SPATIAL-TEMPORAL-4x4-NEXT:         %c0_13 = arith.constant 0 : index
// MAP-SPATIAL-TEMPORAL-4x4-NEXT:         memref.store %8, %arg13[%c0_13] : memref<?xi32>
// MAP-SPATIAL-TEMPORAL-4x4-NEXT:         taskflow.hyperblock.yield
...
// MAP-SPATIAL-TEMPORAL-4x4-NEXT:       %c1_9 = arith.constant 1 : index
// MAP-SPATIAL-TEMPORAL-4x4-NEXT:       %2 = taskflow.counter parent(%1 : index) from %c0_8 to %c7 step %c1_9 : index
...
// MAP-SPATIAL-TEMPORAL-4x4-NEXT:       %c1_9 = arith.constant 1 : index
// MAP-SPATIAL-TEMPORAL-4x4-NEXT:       %2 = taskflow.counter parent(%1 : index) from %c0_8 to %c9 step %c1_9 : index
// MAP-SPATIAL-TEMPORAL-4x4-NEXT:       "taskflow.hyperblock"(%1, %2) <{operandSegmentSizes = array<i32: 2, 0>}> ({
...
// MAP-SPATIAL-TEMPORAL-1x1-NEXT:       %c1_9 = arith.constant 1 : index
// MAP-SPATIAL-TEMPORAL-1x1-NEXT:       %2 = taskflow.counter parent(%1 : index) from %c0_8 to %c8 step %c1_9 : index
// MAP-SPATIAL-TEMPORAL-1x1-NEXT:       %c0_10 = arith.constant 0 : index
// MAP-SPATIAL-TEMPORAL-1x1-NEXT:       %c6 = arith.constant 6 : index
// MAP-SPATIAL-TEMPORAL-1x1-NEXT:       %c1_11 = arith.constant 1 : index
// MAP-SPATIAL-TEMPORAL-1x1-NEXT:       %3 = taskflow.counter parent(%2 : index) from %c0_10 to %c6 step %c1_11 : index
...
// MAP-SPATIAL-TEMPORAL-1x1-NEXT:       %c1_11 = arith.constant 1 : index
// MAP-SPATIAL-TEMPORAL-1x1-NEXT:       %3 = taskflow.counter parent(%2 : index) from %c0_10 to %c5 step %c1_11 : index
// MAP-SPATIAL-TEMPORAL-1x1-NEXT:       "taskflow.hyperblock"(%1, %2, %3) <{operandSegmentSizes = array<i32: 3, 0>}> ({
...
// MAP-SPATIAL-TEMPORAL-1x1-NEXT:         %6 = arith.addi %4, %5 : i32
// MAP-SPATIAL-TEMPORAL-1x1-NEXT:         %c0_12 = arith.constant 0 : index
// MAP-SPATIAL-TEMPORAL-1x1-NEXT:         %7 = memref.load %arg13[%c0_12] : memref<?xi32>
// MAP-SPATIAL-TEMPORAL-1x1-NEXT:         %8 = arith.addi %7, %6 : i32
// MAP-SPATIAL-TEMPORAL-1x1-NEXT:         %c0_13 = arith.constant 0 : index
// MAP-SPATIAL-TEMPORAL-1x1-NEXT:         memref.store %8, %arg13[%c0_13] : memref<?xi32>
// MAP-SPATIAL-TEMPORAL-1x1-NEXT:         taskflow.hyperblock.yield
...
// MAP-SPATIAL-TEMPORAL-1x1-NEXT:       %c1_9 = arith.constant 1 : index
// MAP-SPATIAL-TEMPORAL-1x1-NEXT:       %2 = taskflow.counter parent(%1 : index) from %c0_8 to %c7 step %c1_9 : index
...
// MAP-SPATIAL-TEMPORAL-1x1-NEXT:       %c1_9 = arith.constant 1 : index
// MAP-SPATIAL-TEMPORAL-1x1-NEXT:       %2 = taskflow.counter parent(%1 : index) from %c0_8 to %c9 step %c1_9 : index
// MAP-SPATIAL-TEMPORAL-1x1-NEXT:       "taskflow.hyperblock"(%1, %2) <{operandSegmentSizes = array<i32: 2, 0>}> ({
...
// MAP-SPATIAL-TEMPORAL-1x2-NEXT:       %c1_9 = arith.constant 1 : index
// MAP-SPATIAL-TEMPORAL-1x2-NEXT:       %2 = taskflow.counter parent(%1 : index) from %c0_8 to %c8 step %c1_9 : index
// MAP-SPATIAL-TEMPORAL-1x2-NEXT:       %c0_10 = arith.constant 0 : index
// MAP-SPATIAL-TEMPORAL-1x2-NEXT:       %c6 = arith.constant 6 : index
// MAP-SPATIAL-TEMPORAL-1x2-NEXT:       %c1_11 = arith.constant 1 : index
// MAP-SPATIAL-TEMPORAL-1x2-NEXT:       %3 = taskflow.counter parent(%2 : index) from %c0_10 to %c6 step %c1_11 : index
...
// MAP-SPATIAL-TEMPORAL-1x2-NEXT:       %c1_11 = arith.constant 1 : index
// MAP-SPATIAL-TEMPORAL-1x2-NEXT:       %3 = taskflow.counter parent(%2 : index) from %c0_10 to %c5 step %c1_11 : index
// MAP-SPATIAL-TEMPORAL-1x2-NEXT:       "taskflow.hyperblock"(%1, %2, %3) <{operandSegmentSizes = array<i32: 3, 0>}> ({
...
// MAP-SPATIAL-TEMPORAL-1x2-NEXT:         %6 = arith.addi %4, %5 : i32
// MAP-SPATIAL-TEMPORAL-1x2-NEXT:         %c0_12 = arith.constant 0 : index
// MAP-SPATIAL-TEMPORAL-1x2-NEXT:         %7 = memref.load %arg13[%c0_12] : memref<?xi32>
// MAP-SPATIAL-TEMPORAL-1x2-NEXT:         %8 = arith.addi %7, %6 : i32
// MAP-SPATIAL-TEMPORAL-1x2-NEXT:         %c0_13 = arith.constant 0 : index
// MAP-SPATIAL-TEMPORAL-1x2-NEXT:         memref.store %8, %arg13[%c0_13] : memref<?xi32>
// MAP-SPATIAL-TEMPORAL-1x2-NEXT:         taskflow.hyperblock.yield
...
// MAP-SPATIAL-TEMPORAL-1x2-NEXT:       %c1_9 = arith.constant 1 : index
// MAP-SPATIAL-TEMPORAL-1x2-NEXT:       %2 = taskflow.counter parent(%1 : index) from %c0_8 to %c7 step %c1_9 : index
...
// MAP-SPATIAL-TEMPORAL-1x2-NEXT:       %c1_9 = arith.constant 1 : index
// MAP-SPATIAL-TEMPORAL-1x2-NEXT:       %2 = taskflow.counter parent(%1 : index) from %c0_8 to %c9 step %c1_9 : index
// MAP-SPATIAL-TEMPORAL-1x2-NEXT:       "taskflow.hyperblock"(%1, %2) <{operandSegmentSizes = array<i32: 2, 0>}> ({
