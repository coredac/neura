...
enum OperationKind {
  ...
  // No modeled functional unit. Unknown operations remain unconstrained rather
  // than silently being priced as integer additions.
  IUnknown = 43
};
...
// `Architecture`, so the mapper, the budgeted CP-SAT mapper, --dump-dfg-json,
